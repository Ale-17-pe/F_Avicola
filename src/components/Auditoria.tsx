...
export function Auditoria() {
  ...
  // Datos de ejemplo de logs de auditoría
  const logsAuditoria: AuditoriaLog[] = [
    // 2025-02-03
    {
      ...
      cargo: 'Administrador',
      accion: 'Creó nuevo empleado',
      modulo: 'Recursos Humanos',
      detalles: 'Empleado: Ana García López - DNI: 12345678 - Cargo: Secretaria',
      fecha: '2025-02-03',
      hora: '14:15:23',
      tipo: 'crear',
      estado: 'exitoso',
    ...
    },
    {
      ...
      usuario: 'Admin Usuario',
      cargo: 'Administrador',
      accion: 'Editó cliente',
      modulo: 'Clientes',
      detalles: 'Cliente: Restaurante El Sabor - Cambió teléfono de contacto',
      fecha: '2025-02-03',
      hora: '13:30:45',
      tipo: 'editar',
      estado: 'exitoso',
    ...
    {
      id: '3',
      usuario: 'Carlos Mendoza Ruiz',
      cargo: 'Producción',
      accion: 'Registró asistencia',
      modulo: 'Asistencia',
      detalles: 'Entrada manual: 09:05 AM - Tardanza',
      fecha: '2025-02-03',
      hora: '09:05:12',
      tipo: 'crear',
      estado: 'advertencia',
    ...
    },
    {
      ...
      modulo: 'Informes',
      detalles: 'Reporte: Inventario - Aves (CSV)',
      fecha: '2025-02-03',
      hora: '12:00:00',
      tipo: 'exportar',
      estado: 'exitoso',
    ...
    },
    {
      ...
      cargo: 'Secretaria',
      accion: 'Visualizó pedidos',
      modulo: 'Pedidos',
      detalles: 'Consultó pedido PED-002',
      fecha: '2025-02-03',
      hora: '10:15:30',
      tipo: 'ver',
      estado: 'exitoso',
    ...
    },
    {
      ...
      usuario: 'Admin Usuario',
      cargo: 'Administrador',
      accion: 'Eliminó proveedor',
      modulo: 'Inventario',
      detalles: 'Proveedor: Distribuidora El Gallo (Inactivo)',
      fecha: '2025-02-03',
      hora: '11:30:15',
      tipo: 'eliminar',
      estado: 'exitoso',
    ...
    {
      id: '7',
      usuario: 'María Torres Silva',
      cargo: 'Pesaje',
      accion: 'Intentó acceder a finanzas',
      modulo: 'Finanzas',
    ...
    },
    {
      ...
      usuario: 'Admin Usuario',
      cargo: 'Administrador',
      accion: 'Creó nuevo pedido',
      modulo: 'Pedidos',
      detalles: 'Pedido PED-004 - Cliente: Restaurante El Sabor - 60 kg Pollo',
      fecha: '2025-02-03',
      hora: '11:30:45',
      tipo: 'crear',
      estado: 'exitoso',
    ...
    {
      id: '9',
      usuario: 'Jorge Ramírez Pérez',
      cargo: 'Seguridad',
      accion: 'Registró entrada',
      modulo: 'Asistencia',
      detalles: 'Entrada escaneada: 07:45 AM',
      fecha: '2025-02-03',
      hora: '07:45:00',
      tipo: 'crear',
      estado: 'exitoso',
    ...
    },
    {
      ...
      usuario: 'Admin Usuario',
      cargo: 'Administrador',
      accion: 'Actualizó precios',
      modulo: 'Costos de Clientes',
      detalles: 'Cliente: Pollería Don José - Pollo: S/ 8.80/kg',
      fecha: '2025-02-03',
      hora: '12:00:00',
      tipo: 'editar',
      estado: 'exitoso',
    ...
    // 2025-02-02
    {
      ...
      accion: 'Exportó reporte',
      modulo: 'Informes',
      detalles: 'Reporte: Recursos Humanos - Empleados (CSV)',
      fecha: '2025-02-02',
      hora: '16:45:30',
      tipo: 'exportar',
      estado: 'exitoso',
    ...
    },
    {
      ...
      modulo: 'Asistencia',
      detalles: 'Salida manual: 17:45 PM',
      fecha: '2025-02-02',
      hora: '17:45:00',
      tipo: 'crear',
      estado: 'exitoso',
    ...
    },
    {
      ...
      usuario: 'Admin Usuario',
      cargo: 'Administrador',
      accion: 'Creó nuevo envío',
      modulo: 'Distribución',
      detalles: 'Envío ENV-004 - Pedido PED-004 - Chofer: Juan Pérez',
      fecha: '2025-02-02',
      hora: '14:20:00',
      tipo: 'crear',
      estado: 'exitoso',
    ...
    },
    {
      ...
      usuario: 'Ana García López',
      cargo: 'Secretaria',
      accion: 'Editó información de cliente',
      modulo: 'Clientes',
      detalles: 'Cliente: Mercado Central - Actualizó dirección',
      fecha: '2025-02-02',
      hora: '10:30:00',
      tipo: 'editar',
      estado: 'exitoso',
    ...
    },
    {
      ...
      modulo: 'Dashboard',
      detalles: 'Acceso al panel principal',
      fecha: '2025-02-02',
      hora: '08:00:00',
      tipo: 'acceso',
      estado: 'exitoso',
    ...
    },
    {
      ...
      usuario: 'María Torres Silva',
      cargo: 'Pesaje',
      accion: 'Registró peso de aves',
      modulo: 'Inventario',
      detalles: 'Lote: 50 pollos - Peso promedio: 2.5 kg',
      fecha: '2025-02-02',
      hora: '09:30:00',
      tipo: 'crear',
      estado: 'exitoso',
    ...
    // 2025-02-01
    {
      ...
      modulo: 'Clientes',
      detalles: 'Cliente: Restaurant Los Rosales - Contacto: Pedro Sánchez',
      fecha: '2025-02-01',
      hora: '15:20:00',
      tipo: 'crear',
      estado: 'exitoso',
    ...
    },
    {
      ...
      modulo: 'Inventario',
      detalles: 'Aves: Pollo Macho - Stock actualizado: 150 unidades',
      fecha: '2025-02-01',
      hora: '13:45:00',
      tipo: 'editar',
      estado: 'exitoso',
    ...
    },
    {
      ...
      usuario: 'Carlos Mendoza Ruiz',
      cargo: 'Producción',
      accion: 'Intentó eliminar proveedor',
      modulo: 'Inventario',
      detalles: 'Proveedor: Granja San José - Acción denegada: proveedor con pedidos activos',
      fecha: '2025-02-01',
      hora: '11:15:00',
      tipo: 'eliminar',
      estado: 'fallido',
    ...
    },
    {
      ...
      accion: 'Exportó reporte',
      modulo: 'Informes',
      detalles: 'Reporte: Clientes - Todos los Clientes (CSV)',
      fecha: '2025-02-01',
      hora: '10:00:00',
      tipo: 'exportar',
      estado: 'exitoso',
    ...
    },
    {
      ...
      accion: 'Registró entrada',
      modulo: 'Asistencia',
      detalles: 'Entrada escaneada: 07:50 AM',
      fecha: '2025-02-01',
      hora: '07:50:00',
      tipo: 'crear',
      estado: 'exitoso',
    ...
    },
    {
      ...
      accion: 'Registró entrada',
      modulo: 'Asistencia',
      detalles: 'Entrada manual: 08:10 AM - Tardanza',
      fecha: '2025-02-01',
      hora: '08:10:00',
      tipo: 'crear',
      estado: 'advertencia',
