...
export function LayoutCobranza() {
  ...
  const navigationItems: MenuItem[] = [
    {
      ...
      path: "/dashboard-cobranza/gestion",
      icon: Wallet,
    },
    {
      label: "Historial de Pagos",
      path: "/dashboard-cobranza/historial",
      icon: History,
    },
  ];
  ...
  const getCurrentTitle = () => {
    ...
    if (location.pathname === '/dashboard-cobranza') return "Gestión de Cobranza";
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: c.bgPage, color: c.text, transition: 'background 0.25s ease, color 0.25s ease' }}>
      ...
      <header
        ...
        style={{ background: c.bgSidebarAlt, borderColor: c.borderGold, boxShadow: c.shadowHeader }}
      >
