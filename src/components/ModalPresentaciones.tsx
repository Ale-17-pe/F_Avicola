    ...
    if (editingPresentacion) {
      ...
      setPresentaciones(
        presentaciones.map((p) =>
          p.id === editingPresentacion.id ? presentacionActualizada : p,
        ),
      );
      ...
      const nombreNormalizado = nuevaPresentacionForm.nombre
        .trim()
        .toLowerCase();
      const existe = presentaciones.some(
        (p) =>
          p.nombre.toLowerCase() === nombreNormalizado &&
          p.tipoAve === nuevaPresentacionForm.tipoAve,
      );

      if (existe) {
        alert(
          `La presentación "${nuevaPresentacionForm.nombre}" ya está registrada para ${nuevaPresentacionForm.tipoAve}.`,
        );
        return;
      }
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="overflow-y-auto p-3 sm:p-5 md:p-6 lg:p-8"
            ...
            <div className="lg:col-span-2">
              ...
              >
                ...
                >
                  ...
                  <div>
                    <label
                      className="block text-xs sm:text-sm font-bold mb-2 sm:mb-3"
                      style={{ color: "#ccaa00" }}
                    >
                  ...
                  {nuevaPresentacionForm.mermaKg &&
                    parseFloat(nuevaPresentacionForm.mermaKg) >= 0 && (
                      <div
                      ...
                      >
                        <p
                          className="text-xs font-bold mb-2 sm:mb-3"
                          style={{ color: "#22c55e" }}
                        >
                        ...
                        <div
                          className="mt-2 sm:mt-3 p-2 rounded-lg text-center"
                        ...
                        >
                          ...
                          >
                            500 aves ={" "}
                            {(
                              500 * parseFloat(nuevaPresentacionForm.mermaKg)
                            ).toFixed(2)}{" "}
                            kg de merma
                          </p>
                        </div>
                ...
                >
                  {tiposAve
                    .filter(
                      (tipo) =>
                        filtroPresentacionTipo === "all" ||
                        filtroPresentacionTipo === tipo.nombre,
                    )
                    .map((tipo) => {
                      const presentacionesDelTipo = presentaciones.filter(
                        (p) => p.tipoAve === tipo.nombre,
                      );
                      const isExpanded = expandedTypes.includes(tipo.nombre);
                          ...
                          >
                            <div className="flex items-center gap-3">
                              <div
                                ...
                                style={{
                                  background:
                                    "linear-gradient(135deg, rgba(204, 170, 0, 0.2), rgba(0, 0, 0, 0.2))",
                                  border: "1px solid rgba(204, 170, 0, 0.3)",
                                }}
                              >
                                  ...
                                  (presentacion, index) => (
                                    ...
                                    >
                                      <div className="flex items-center justify-between gap-2 sm:gap-3 md:gap-4">
                                        <div className="flex items-center gap-2 sm:gap-3 md:gap-4 flex-1 min-w-0">
                                          <div
                                            className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl flex items-center justify-center font-bold text-sm sm:text-base flex-shrink-0"
                                            style={{
                                              background:
                                                "linear-gradient(135deg, #ccaa00, #b8941e)",
                                              color: "#000",
                                              boxShadow:
                                                "0 4px 15px rgba(204, 170, 0, 0.3)",
                                            }}
                                          >
                                            {index + 1}
                                          </div>
